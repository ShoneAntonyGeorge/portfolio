...
export default function Socials(){
    return(
        <div className={`bg-[#f9bc57] md:pb-[30vh] md:pt-10 w-full md:pr-0 pr-25 md:w-[${style.md_socialsWidth}] md:h-full h-20 absolute top-0 flex md:flex-col justify-between items-center`}>
